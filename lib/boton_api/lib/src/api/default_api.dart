...
class DefaultApi {
  ...
  Future<Response<EnviarMensajePostRequest>> checarComunicacionGet({ 
    ...
    final _path = r'/checarComunicacion';
    ...
    EnviarMensajePostRequest? _responseData;
    ...
    return Response<EnviarMensajePostRequest>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [enviarAlertaPostRequest] - Datos de la solicitud
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<EnviarAlertaPost200Response>> enviarAlertaPost({ 
    ...
    EnviarAlertaPost200Response? _responseData;
    ...
    return Response<EnviarAlertaPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<EnviarMensajePost200Response>> enviarAudioPost({ 
    ...
    EnviarMensajePost200Response? _responseData;
    ...
    return Response<EnviarMensajePost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ReportesListarGet200ResponseInner>>> reportesListarGet({ 
    ...
    BuiltList<ReportesListarGet200ResponseInner>? _responseData;
    ...
    return Response<BuiltList<ReportesListarGet200ResponseInner>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ReportesListarGet200ResponseInner>> reportesObtenerIdGet({ 
    ...
    ReportesListarGet200ResponseInner? _responseData;
    ...
    return Response<ReportesListarGet200ResponseInner>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
